...
// in gray code, two most MSB need to be different
...
assign rd_axis_vld = rd_axis_vld_reg && ~rd_rst_sync3_reg;
...
always @* begin
    ...
    // input data valid
    if (~full && wr_axis_vld && wr_axis_rdy && !wr_rst_sync3_reg) begin
...
always @* begin
    ...
    if (~empty && (!rd_axis_vld_reg || rd_axis_rdy)) begin
