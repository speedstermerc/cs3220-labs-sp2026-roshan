    ...
    , TOP{this, namep}
{
    ...
    __Vscopep_pipeline__my_AGEX_stage->varInsert("correct_branches", &(TOP__pipeline__my_AGEX_stage.correct_branches), false, VLVT_UINT32, VLVD_NODIR|VLVF_PUB_RW, 0, 1 ,31,0);
